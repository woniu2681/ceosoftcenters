...
public class PayComponentXML_New {
  public static void main(String[] args) throws Exception {
    SAXBuilder builder = new SAXBuilder();
    JDOMXPath badgeNumberXPath = new JDOMXPath("/PerPerson/Current/EmpJob/customString4");
    JDOMXPath compensationXPath = new JDOMXPath("/PerPerson/Current/EmpCompensation/*");
    ...
    for (int i = 0; i < 1; i++) {
      ...
      for (Element e : list) {
        if (!e.getName().startsWith("EmpPayCompRecurring")) {
          continue;
        }
